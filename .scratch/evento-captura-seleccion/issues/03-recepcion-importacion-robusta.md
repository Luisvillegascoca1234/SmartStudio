...
**Blocked by:** 02 — Completar el ciclo de eventos, sesiones fotográficas y series.
...
- [x] Una captura cuyo RAW no llega queda identificada como incompleta sin desaparecer de la sesión fotográfica.
