...
- [x] El espacio crítico sin SSD permite terminar la sesión activa, pero bloquea el inicio de una nueva.
...
- [x] Una desconexión o fallo del SSD genera una alerta visible y sonora sin borrar archivos ni detener indebidamente la sesión activa.
