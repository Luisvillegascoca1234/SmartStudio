...
**What to build:** incorporar una captura RAW + JPEG tomada con la Sony A7 IV conectada por USB al mismo recorrido de evento, sesión fotográfica, serie y selección que ya funciona con la fuente simulada.
...
- [ ] Al menos un par RAW + JPEG real llega por USB a una sesión fotográfica y serie activas.
...
- [x] La integración no modifica las reglas de sesiones fotográficas, series, selección, persistencia ni respaldo.
